...
const colorByLength = Object.keys(colors).sort((a, b) => a.length - b.length); // console.log(colorByLength);
...
function handleResult({
  ...
  // logWords(results);
  const words = results[results.length - 1][0].transcript; // Lowercase everithing

  let color = words.toLowerCase(); // Strip any spaces out

  color = color.replace(/\s/g, "");
  if (!(0, _colors.isValidColor)(color)) return;
  console.log("this is a valid color"); // Check if it is a valid colour
...
start();
colorEl.innerHTML = displayColors(_colors.colorByLength);
},{"./handlers":"handlers.js","./colors":"colors.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
